    ...
    def islandsAndTreasure(self, grid: List[List[int]]) -> None:
        ...
        def bfs(r, c, dist):
            ...
            while q:
                ...
                # print(f'row {popped_r}, col {popped_c}, dist {popped_dist}, val {grid[popped_r][popped_c]}')
                ...
                for dr, dc in dirs:
                    ...
                    if new_r in range(rows) and new_c in range(cols) and (new_r, new_c) not in popped_seen:
                        if grid[new_r][new_c] == 0:
                            print(grid[new_r][new_c], popped_dist)
                            print(f'TRIED TO RETURN DIST at {new_r} {new_c}')
                            return popped_dist
